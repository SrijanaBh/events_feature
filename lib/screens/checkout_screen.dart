...
class _CheckOutButtonState extends State<CheckOutButton>
  ...
  List<Map<String, dynamic>> createOrders() {
    ...
    for (var i in selectedTicketsList) {
      final qty = widget.selectedTickets[i.id] ?? 0;
      _createOrderPayload.add({
        "id": i.id,
        "type": 6,
        "numberOfTickets": qty,
        "actualPrice": i.price,
        "discountPrice": i.price, // TODO: handle discount logic
        "entryUpto": i.persons,
        "endTime": i.endTime,
        "selected_date": i.egDate,
        "price_gst": 0,
      });
    }
      ...
      onPressed: () async {
        ...
        _checkoutPro.openCheckoutScreen(
          payUPaymentParams: PayUParams.createPayUPaymentParams(
            ...
            productInfo: widget.event.title,
